package kr.co.lion.guitarapp.ui.setting
...
import kr.co.lion.guitarapp.databinding.ActivitySettingBinding
...
import kr.co.lion.guitarapp.ui.setting.fragment.SettingMainFragment
import kr.co.lion.guitarapp.util.AttendanceFragmentName
import kr.co.lion.guitarapp.util.SettingFragmentName
...
class SettingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        replaceFragment(SettingFragmentName.SETTING_MAIN_FRAGMENT,false,false,null)
    ...
    fun replaceFragment(name: SettingFragmentName, addToBackStack:Boolean, isAnimate:Boolean, data:Bundle?){
        ...
        when(name){
            SettingFragmentName.SETTING_MAIN_FRAGMENT -> {
                newFragment = SettingMainFragment()
            }
        ...
        if(newFragment != null){
            ...
            fragmentTransaction.replace(R.id.fragmentContainerSetting, newFragment!!)
